		...
		<div class="container">
						...
						<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
							<nav class="stroke">
								<ul class="nav navbar-nav">
									...
									<li><a href="file_part" class="hvr-underline-from-left"><i class="picture1"></i>Files</a></li>
			...
			<div class="col-xs-9 banner-body-right">
				...
				<div class="mail">
					...
					<div class="mail-grid1">
						<h3>Write a <span>New Post</span></h3>
						<p>Keep calm and happy</p>
						
						<form:form method="post" action="save_post" commandName="post">
							<!-- catalog name -->
							<br><h4>Catalog</h4>
							<input type="text" class="form-control" name="catalogName" placeholder="Catalog" aria-describedby="basic-addon2">
							
							<br><h4>Title</h4>
								<form:input type="text" placeholder="Post Title" path="postTitle" required=" " />																					
							
							<br><h4>Content</h4>
								<form:textarea placeholder="Type Your Text Here...." path="postContent" />
